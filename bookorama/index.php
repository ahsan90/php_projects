...
// Purpose: showing all the books from DB
require('./admin/auth/LoginHelper.php');
?>
    ...
    <body>
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./admin/auth/login.php">Login</a>
                        </li>
                        <?php }else {?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./admin/auth/logout.php">Logout</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="main-content">
                ...
                //echo "<p class='alert-success'>".$query."</p>";
